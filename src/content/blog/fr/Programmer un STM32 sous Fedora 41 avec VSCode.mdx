...
![Installation de l’extension STM32](../../images/565cda6a1352ebb74c1f97efc3d0f1c7_MD5.jpeg)
...
![Paramètres de l’extension STM32](../../images/IMG_Programmer_un_STM32_sous_Fedora_41_avec_VSCode.png)
...
1. Dans VSCode, ouvrir l’onglet **STM32 VS Code Extension**.  
   ![Onglet STM32 VS Code Extension](../../images/85d1b2484bc351e1ddb9969595ccfcf6_MD5.jpeg)

2. Lancer **STM32CubeMX** via le bouton dédié.  
   ![Lancement de STM32CubeMX](../../images/fe988d8c065be00f56923fec8f9de010_MD5.jpeg)

3. Créer un nouveau projet.  
   ![Création d’un nouveau projet](../../images/dad1056dd12d64d3da419120abf90026_MD5.jpeg)

   - Sélectionner la carte ou le microcontrôleur concerné.  
     ![Sélection de la carte](../../images/d97e0308efb265549dd2d49b6db77125_MD5.jpeg)

   - Vérifier la configuration de la LED (GPIO) et noter le “User Label”.  
     ![Configuration de la LED](../../images/f33b7af6c74c024efb1924b979d1152b_MD5.jpeg)

   - Vérifier que l’UART est bien activé et configuré en **115200 Baud**.  
     ![Configuration de l’UART](../../images/1b1634ca22f9d64a3e286ec4ebb61a0b_MD5.jpeg)

4. Dans l’onglet **Project Manager**, choisir le nom du projet et générer le code.  
   > **Important** : Sélectionner **CMake** comme toolchain !  
   ![Project Manager - Génération du code](../../images/38e1bcc86ec027345ccf54802b507a1a_MD5.jpeg)

5. De retour dans VSCode, **importer le projet CMake**.  
   ![Importation du projet CMake](../../images/6f0effcd4ef4d3a78261265f03e778d3_MD5.jpeg)
...
![Lancement du débogueur](../../images/03ad4d833cd46a328094ed00fc7ad68d_MD5.jpeg)
...
![Sortie UART dans le terminal](../../images/d50c96450533bb1c400e9639886e5d96_MD5.jpeg)
