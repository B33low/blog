...
Early in my testing, I noticed that when the wires for Chip Select (CS) and Master Out Slave In (MOSI) were too close together (less than 2 cm) interference occurred. This would completely broke communication with the sensor.
...
![Original breadboard setup] (../../images/breadboard-sensor.webp)
